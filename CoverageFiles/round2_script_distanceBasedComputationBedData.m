%same as script_distanceBasedComputationBedData, but for trial only
num_features_to_select = 200 

%% For CGR data -
male_datafile = 'DataFiles/DistanceBased/round_2/CGR/ALL_MALE.sorted.bed'
M = load_data_from_BED(male_datafile)    
female_datafile = 'DataFiles/DistanceBased/round_2/CGR/ALL_FEMALE.sorted.bed'
...
%% For VT data
male_datafile = 'DataFiles/DistanceBased/round_2/VT/MALE_SRA.sorted.bed'
M = load_data_from_BED(male_datafile)    
female_datafile = 'DataFiles/DistanceBased/round_2/VT/FEMALE_SRA.sorted.bed'
F = load_data_from_BED(female_datafile)
...
%% Write results
OutputListFile = strcat('round2_CGR_VT_OutOfTop_',num2str(num_features_to_select));
